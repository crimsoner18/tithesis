...
import questions from '../../../assets/questions/module1/quiz4.json'; 
...
export default function QuizScreen({ navigation }: RootTabScreenProps<'Quiz'>) {
  ...
  const setLessonAsRead = async (value: string) => {
    try {
      await AsyncStorage.setItem('@M1L4isRead', value);
      await AsyncStorage.setItem('@M1L4Passed', value);
    } catch (e) {
      console.log(e)
    }
  }
